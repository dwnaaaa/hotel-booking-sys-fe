...
const Admin = () => {
    ...
    const [selectedType, setSelectedType] = useState('F')
    const [typeDisplay, setTypeDisplay] = useState('Front Desk')

    const updateType = (type) => {
        setSelectedType(type)
        switch(type) {
            case 'F':
                setTypeDisplay('Front Desk')
                break
            case 'H':
                setTypeDisplay('Housekeeping')
                break
            case 'K':
                setTypeDisplay('Kitchen')
                break
            case 'C':
                setTypeDisplay('Concierge')
                break
        }
    }
    ...
    if(localStorage.getItem('type') !== 'S') {
        ...
        return (
            ...
            <div>
                ...
                <a className="admin_card" onClick={() => updateType('F')}>
                ...
                {/* <a href="/dashboard" className="admin_card"> */}
                <a className="admin_card" onClick={() => updateType('H')}>
                <div className="card-image-container" >
                    <div className="image-wrapper">
                ...
                {/* <a href="/dashboard" className="admin_card"> */}
                <a className="admin_card" onClick={() => updateType('K')}>
                <div className="card-image-container" >
                    <div className="image-wrapper">
                ...
                {/* <a href="/dashboard" className="admin_card"> */}
                <a className="admin_card" onClick={() => updateType('C')}>
                <div className="card-image-container">
                    <div className="image-wrapper">
